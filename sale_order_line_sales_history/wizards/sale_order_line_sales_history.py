...
class SaleOrderLineSalesHistory(models.TransientModel):
    _name = "sale.order.line.sales.history"
    _description = "Sale order line sales history"
    ...
    line_ids = fields.One2many(
        comodel_name="sale.order.line.sales.history.line",
...
class SaleOrderLineSalesHistoryline(models.TransientModel):
    _name = "sale.order.line.sales.history.line"
    _description = "Sale order line sales history line"

    history_id = fields.Many2one(
        comodel_name="sale.order.line.sales.history",
        string="History",
    )
